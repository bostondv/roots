...
if ( $order ) : ?>
	...
	<?php if ( $order->has_status( 'failed' ) ) : ?>
		...
		<div class="alert alert-warning"><?php _e( 'Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction.', 'woocommerce' ); ?></div>
		...
		<div>
			...
			<a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'myaccount' ) ) ); ?>" class="btn btn-default"><?php _e( 'My Account', 'woocommerce' ); ?></a>
			<?php endif; ?>
		</div>
