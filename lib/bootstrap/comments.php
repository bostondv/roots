...
class Roots_Walker_Comment extends Walker_Comment {
  ...
  <li id="comment-<?php comment_ID(); ?>" <?php comment_class('media comment-' . get_comment_ID()); ?> itemscope itemtype="https://schema.org/UserComments">
...
function roots_get_avatar($avatar, $type) {
  ...
  $avatar = str_replace("class='avatar", "itemprop='image' class='avatar pull-left media-object thumbnail", $avatar);
  return $avatar;
}
